...
import { CustomTheme, alpha } from "@mui/material/styles";
import PropTypes from "prop-types";
import { forwardRef, useCallback } from "react";
import Iconify from "../iconify";

// TODO: remove any and add proper types
const ColorPicker = forwardRef(({ colors, selected, onSelectColor, limit = "auto", sx, ...other }: any, ref) => {
          ...
          <ButtonBase
            ...
            <Stack
              ...
              <Iconify
                ...
                sx={{
                  color: (theme: CustomTheme) => theme.palette.getContrastText(color),
                  transition: (theme: CustomTheme) =>
                    theme.transitions.create("all", {
                      duration: theme.transitions.duration.shortest,
                    }),
                }}
